...
moken-dapp is a customized DApp written in Python, which originally resembles the one provided by the sample [Echo Python DApp](https://github.com/cartesi/rollups-examples/tree/main/echo-python).
...
ROLLUP_HTTP_SERVER_URL="http://127.0.0.1:5004" python3 moken-dapp.py
```
...
```shell
ls *.py | ROLLUP_HTTP_SERVER_URL="http://127.0.0.1:5004" entr -r python3 moken-dapp.py
```
